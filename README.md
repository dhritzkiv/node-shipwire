...
- Strategy for handling errors in response
- Incorporate [planned](https://twitter.com/shipwire/status/443435986702598144) native JSON response from Shipwire once it lands
